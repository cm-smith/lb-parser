...
/* 
 * LoadDocument - loads the HTML documentation from a given file name
 * @fileName: the name of the file to be loaded
 *
 * Returns a string containing the loaded document
 *
 */
char *LoadDocument(char *fileName);

/*
 * GetDocumentId - generates the document identifier from the name of a file
 * @fileName: the name of the file to get document identifier for
 *
 * Returns an integer identifier for that document
 *
 */
